...
public class HighscoreButtons {
    ...
    public HighscoreButtons(GameMain game) {
        ...
        createAndPostitionUIElements();
        stage.addActor(backBtn);
        stage.addActor(scoreLabel);
        stage.addActor(coinLabel);
    }

    void createAndPostitionUIElements() {
        ...
        coinLabel = new Label(String.valueOf(GameManager.getInstance().gameData.getCoinHighscore()), new Label.LabelStyle(scoreFont, Color.WHITE));
        backBtn.setPosition(GameInfo.WIDTH-17, 17, Align.bottomRight);
        scoreLabel.setPosition(GameInfo.WIDTH / 2f-20, GameInfo.HEIGHT / 2f - 120);
        coinLabel.setPosition(GameInfo.WIDTH / 2f-20, GameInfo.HEIGHT / 2f - 220);
